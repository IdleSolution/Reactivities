    ...
    public class Add
    {
        ...
        public class Handler : IRequestHandler<Command>
        {
            ...
            public async Task<Unit> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                if(target == null)
                {
                    throw new RestException(HttpStatusCode.NotFound, new {User = "User does not exist!"});
                }
                ...
                if(following != null)
                {
                    throw new RestException(HttpStatusCode.BadRequest, new {User = "User is already being followed!"});
                }
