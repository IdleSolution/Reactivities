...
import { IActivitiesEnvelope, IActivity } from '../../modules/activity';
import { IPhoto, IProfile, IProfileFormValues } from '../../modules/profile';
...
axios.interceptors.response.use(undefined, error => {
    ...
    } else if(status === 401 && headers['www-authenticate'].includes('Bearer error="invalid_token"')) {
...
const Profiles = {
    ...
    edit: (values: IProfileFormValues) => requests.put(`/profiles`, values),
